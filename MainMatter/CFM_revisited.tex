...
From this idea for a simple density field to an \textit{order parameter density field}, the step is really short: it suffices modifying the instantaneous atomistic ``density'' as follows
\begin{equation}
\label{eqn:op-field1}
