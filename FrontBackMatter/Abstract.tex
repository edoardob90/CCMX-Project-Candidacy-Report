...
%This more difficult task will require the development of reliable and accurate methods to study this class of properties (to which belongs, for example, the anisotropy of solid--liquid interface free energy).
%To fulfil this far more complex challenge, we will address part of the work on in--depth investigation of more advanced and transferable interatomic potentials, exploiting powerful methods such as Neural Networks.
